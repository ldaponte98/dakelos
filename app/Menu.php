	    			...
	    			$menu .= '<li class="menu-item-has-children dropdown">
	                        	...
	                        	foreach ($menu_hijos as $menu_hijo) {
	                        		...
	                        		$menu_perfil_hijo = MenuPerfil::where('id_perfil', $id_perfil)
						    								 ...
						    								 ->where('estado', 1)
						    								 ->first();
						    		if($menu_perfil_hijo) $menu .= '<li><i class="fa fa-'.$menu_hijo->icono.'"></i> <a href="/'.$menu_hijo->ruta.'">'.$menu_hijo->nombre.'</a></li>';
	               				}
	               $menu .=   '</ul>
	                    	 </li>';
	    		}else{
	    			...
	    			$menu .= '<li>
	                        	<a href=/"'.$menu_padre->ruta.'"> <i class="fa fa-'.$menu_padre->icono.'"></i>'.$menu_padre->nombre.'</a>
	                    	  </li>';
	    		}
    		}
    	}
