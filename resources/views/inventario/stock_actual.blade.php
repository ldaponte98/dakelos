                                                        ...
                                                        <table class="table" id="table-productos-{{ $item->id_dominio }}">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <center><b>Presentación</b></center>
                                                                    </th>
                                                                    <th>
                                                                        <center><b>Cantidad minima de alerta</b></center>
                                                                    </th>
                                                                    <th>
                                                                        <center><b>Cantidad actual</b></center>
                                                                    </th>
                                                                    <th>
                                                                                ...
                                                                                <center>
                                                                                    ...
                                                                                    @else
                                                                                        @if ($producto->cantidad_actual <= $producto->cantidad_minimo_alerta)
                                                                                            <span
                                                                                                class="badge badge-warning text-black"><b>Por
                                                                                                    agotar</b></span>
                                                                                        @else
                                                                                            <span
                                                                                                class="badge badge-success"><b>Estable</b></span>
                                                                                        @endif
                                                                                    @endif
