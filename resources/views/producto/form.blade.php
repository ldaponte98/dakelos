                ...
                <div id="pay-invoice">
                    <div class="card-body">
                        ...
                        <div class="card-title">
                            <h3 class="text-center">@if($producto->id_producto == null) Crear producto / servicio / ingrediente @else Modificar producto / servicio / ingrediente @endif</h3>
                            @if(count($errors) > 0)
