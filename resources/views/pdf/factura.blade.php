...
<body>
    ...
    <table class="tabla_1" border="1" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td colspan="5" style="border-left: none; border-bottom: none; font-size: 16px; border-top: none;">
                <center><label>Direccion: {{ $factura->licencia->direccion }} {{ $factura->licencia->ciudad }}</label>
                </center>
        ...
        <tr>
            <td colspan="5"
                style="border-left: none; border-top: none; border-bottom: none; font-size: 16px;text-align: center;">
                {{ $factura->licencia->redes_sociales }}</td>
            <td colspan="3">
                <center>{{ $factura->numero }}</center> <br>
            </td>
        </tr>
        <tr>
            <td colspan="5" style="border-left: none; border-top: none; border-bottom: none; font-size: 16px;">
                <center>{{ $factura->licencia->telefono }}</center>
                </td>
            <td colspan="3" style="background-color: #BFBFBF;">
    ...
    <table class="tabla_1" border="1" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="10" style="border-top: none; background-color: #BFBFBF">
        ...
        @if ($factura->servicio_voluntario > 0)
            <tr>
                ...
                <td colspan="3" style="border-bottom: none; background-color: #BFBFBF;"><b>S. VOLUNTARIO:
        ...
        @if ($factura->domicilio > 0)
            <tr>
                <td colspan="7" style="border-bottom: none;  border-top: none;">&nbsp;</td>
                <td colspan="3" style="border-bottom: none; background-color: #BFBFBF;"><b>DOMICILIO:
        ...
        @if ($factura->abono_inicial > 0)
            <tr>
                <td colspan="7" style="border-bottom: none;  border-top: none;">&nbsp;</td>
                <td colspan="3" style="border-bottom: none; background-color: #BFBFBF;"><b>ABONO INICAL:
                    </b>${{ number_format($factura->abono_inicial, 0, '.', '.') }}</td>
            </tr>
        @endif
        @if ($factura->descuento > 0)
            <tr>
                <td colspan="7" style="border-bottom: none;  border-top: none;">&nbsp;</td>
                <td colspan="3" style="border-bottom: none; background-color: #BFBFBF;"><b>DESCUENTO:
        ...
        <tr>
            ...
            <td colspan="3" style="border-bottom: none; background-color: #BFBFBF;">
                <b>{{ $factura->id_dominio_tipo_factura == \App\Dominio::get('Factura a credito (Saldo pendiente)') ? 'PENDIENTE' : 'TOTAL' }}:
