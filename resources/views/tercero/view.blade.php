                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <center>
                                        <img src="@if ($tercero->imagen == null or $tercero->imagen == '') {{ asset('plantilla/images/app/user.jpg') }} @else {{ asset('imagenes/tercero/' . $tercero->imagen) }} @endif"
                                            id="img_imagen" alt="image" class="rounded-circle" width="150" height="150">
                                        <br>
                                        <strong class="card-title span_tipo"><b>{{ $tercero->tipo->nombre
                                                }}</b></strong>
                                    </center>
                                </div>
                            </div>
                            <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="cc-payment" class="control-label mb-1"><b>Fecha de nacimiento:
                                                </b>{{ $tercero->fecha_nacimiento }}</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <div class="card-left pt-1 float-left">
                                            <h3 class="mb-0 fw-r">
                                                ...
                                                <span id="count-1" class="count">{{ $tercero->get_total_deuda()
                                                    }}</span>
                                            </h3>
                                ...
                                <div class="card text-white bg-flat-color-3">
                                    <div class="card-body">
                                        <div class="card-left pt-1 float-left">
                                            <h3 class="mb-0 fw-r">
                                                <span class="currency float-left mr-1">$</span>
                                                <span id="count-2" class="count">{{ $tercero->get_total_ahorro()
                                                    }}</span>
                                            </h3>
                                ...
                                <div class="card text-white bg-flat-color-4">
                                    <div class="card-body">
                                        <div class="card-left pt-1 float-left">
                                            <h3 class="mb-0 fw-r">
                                                <span class="currency float-left mr-1">$</span>
                                                <span id="count-3" class="count">{{ $tercero->get_total_se_le_debe()
                                                    }}</span>
                                            </h3>
