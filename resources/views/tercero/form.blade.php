                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input name="apellidos" type="text" class="form-control" aria-required="true" required aria-invalid="false" value="{{ $tercero->apellidos }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input name="identificacion" type="number" class="form-control" aria-required="true" aria-invalid="false" value="{{ $tercero->identificacion }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
